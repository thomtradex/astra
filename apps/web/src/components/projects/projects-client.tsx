    ...
    <div className="space-y-6">
      ...
      {projects.length === 0 ? (
        <div className="rounded-3xl border bg-white px-6 py-16 text-center shadow-sm">
          <p className="text-sm font-medium text-slate-400">Ainda não existem obras</p>
          <h2 className="mt-2 text-2xl font-semibold text-slate-950">
            Comece pela primeira obra da empresa
          </h2>
          <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-slate-500">
            Registe uma obra real e passe a centralizar a operação da empresa num único espaço.
          </p>
          <Link
            href="/projects/new"
        ...
        <div className="rounded-2xl border bg-white p-10 text-center">
          <p className="font-medium text-slate-900">Nenhuma obra corresponde aos filtros.</p>
          <p className="mt-1 text-sm text-slate-500">Experimente alterar a pesquisa ou o estado.</p>
        </div>
      ) : (
