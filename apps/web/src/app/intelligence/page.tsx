        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span
                  className={`rounded-full px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide ${
                    signal.aiAnalysis.status === 'GENERATED'
            ...
            <div className="shrink-0 rounded-xl bg-white px-3 py-2">
              ...
              <p className="mt-1 text-sm font-semibold text-slate-800">
                {Math.round(signal.aiAnalysis.confidence * 100)}%
              </p>
            </div>
          </div>
          ...
          <div className="mt-3 rounded-xl bg-white p-3">
            ...
            <p className="mt-1.5 text-sm leading-6 text-slate-700">
              {signal.aiAnalysis.rationale}
            </p>
          </div>

          <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-[10px] font-medium uppercase tracking-wide text-slate-400">
            <span>Provider: {signal.aiAnalysis.provider}</span>

            {signal.aiAnalysis.recommendedRecommendationId ? (
              <span>
          ...
          <p className="mt-3 text-[11px] leading-5 text-slate-500">
            A análise AI é consultiva. A decisão operacional continua sujeita às
            permissões, confirmação do utilizador e verificação do estado atual.
          </p>
        </div>
      ) : null}
